...
public class Robot {
     ...
     * @throws PositionOutOfBoundException if robot tries to move
     *         outside of the environment's boundaries
     */
    public boolean moveUp() throws PositionOutOfBoundException, NotEnoughBatteryException {
    	int initialY = this.getEnvironment().getCurrPosY();
    	this.moveToPosition(environment.getCurrPosX(), 
    			this.environment.getCurrPosY() + Robot.MOVEMENT_DELTA);
    	return initialY != this.getEnvironment().getCurrPosY();
    }
     ...
     *         outside of the environment's boundaries
     */
    public boolean moveLeft() throws PositionOutOfBoundException, NotEnoughBatteryException {
    	int initialX = this.getEnvironment().getCurrPosX();
    	this.moveToPosition(this.environment.getCurrPosX() - Robot.MOVEMENT_DELTA,
    			this.environment.getCurrPosY());
    	return initialX != this.getEnvironment().getCurrPosX();
    }
     ...
     *         outside of the environment's boundaries
     */
    public boolean moveRight() throws PositionOutOfBoundException, NotEnoughBatteryException {
    	int initialX = this.getEnvironment().getCurrPosX();
    	this.moveToPosition(this.environment.getCurrPosX() + Robot.MOVEMENT_DELTA,
    			this.environment.getCurrPosY());
    	return initialX != this.getEnvironment().getCurrPosX();
